          ...
          body: jsonEncode(
            <String, dynamic> {
              ...
              "notification" : <String, dynamic>{
                ...
                "body" : "Seller has confirmed your order! Please expect your item to be shipped within 5-7 days."
              },
          ...
          body: jsonEncode(
            <String, dynamic> {
              ...
              "notification" : <String, dynamic>{
                ...
                "body" : "Please expect your item to be delivered in the next few day/s."
              },
